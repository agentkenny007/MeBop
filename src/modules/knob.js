    ...
    t.o = function() {
        ...
        this.run = function() {
            ...
            if (!this.c) {
                ...
                {
                    this.name = "CanvasNotSupportedException";
                    this.message = "Canvas not supported. Please use excanvas on IE8.0.";
    ...
    t.Dial = function() {
        ...
        this.listen = function() {
            ...
            this.$.bind("keydown", function(i) {
                ...
                u = parseInt(String.fromCharCode(s),10);
                if (isNaN(u)) {
