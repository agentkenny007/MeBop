...
class AudioAudible extends Component { // volume icon audible
  render() {
    return (
        <div className="icon audible" title="Mute">
...
class AudioMuted extends Component { // volume icon muted
  render() {
    return (
        <div className="icon muted" title="Unmute">
...
class NextControl extends Component { // forward button large
  render() {
    return (
        <div className="next control" title="Fast Forward/Skip Track">
...
class PauseControl extends Component { // pause button large
  render() {
    return (
        <div className="pause control" title="Pause Track">
...
class PlayControl extends Component { // play button large
  render() {
    return (
        <div className="play control" title="Play Track">
...
class PrevControl extends Component { // back button large
  render() {
    return (
        <div className="prev control" title="Rewind/Replay/Previous Track">
            <svg width="73px" height="81px" viewBox="0 0 73 81">
            <defs>
